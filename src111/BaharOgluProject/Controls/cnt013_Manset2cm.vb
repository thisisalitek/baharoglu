        ...
        Try
            ...
            If NeoTable2.Rows.Count > 0 Then
                ...
                If If0Null(NeoTable2.Rows(0).Item("bGarni2")) = 1 Then
                    If If0Null(NeoTable2.Rows(0).Item("Garni2_RenkID")) <= 0 Then
                        smsg &= "[MANŞET(2cm)] Garni 2 Yaka rengi seçilmemiş!" & vbNewLine
                        bCancel = True
                    End If
                    If If0Null(NeoTable2.Rows(0).Item("Garni2_CizgiRKafaLakosID")) <= 0 Then
                        smsg &= "[MANŞET(2cm)] Garni 2 Çizgi seçilmemiş!" & vbNewLine
                        bCancel = True
                    End If
            ...
            For i As Integer = 0 To NeoTable3.Rows.Count - 1
                ...
                If dr.RowState <> DataRowState.Deleted And dr.RowState <> DataRowState.Detached Then
                    If If0Null(dr("RenkID")) <= 0 Then
                        smsg &= "[MANŞET(2cm)] #" & i + 1 & " satırda renk seçilmemiş!" & vbNewLine
                        bCancel = True
                    End If
            ...
            If If0Null(NeoTable2.Rows(0).Item("bGarni1")) = 1 Then
                For i As Integer = 0 To tbGarni1Cizgiler.Rows.Count - 1
                    ...
                    If dr.RowState <> DataRowState.Deleted And dr.RowState <> DataRowState.Detached Then
                        If If0Null(dr("RenkID")) <= 0 Then
                            smsg &= "[MANŞET(2cm)] Garni1 #" & i + 1 & " satırda renk seçilmemiş!" & vbNewLine
                            bCancel = True
                        End If
            ...
            If If0Null(NeoTable2.Rows(0).Item("bGarni2")) = 1 Then
                For i As Integer = 0 To tbGarni2Cizgiler.Rows.Count - 1
                    ...
                    If dr.RowState <> DataRowState.Deleted And dr.RowState <> DataRowState.Detached Then
                        If If0Null(dr("RenkID")) <= 0 Then
                            smsg &= "[MANŞET(2cm)] Garni2 #" & i + 1 & " satırda renk seçilmemiş!" & vbNewLine
                            bCancel = True
                        End If
                ...
                If (If0Null(MasterTable.Rows(0).Item("Secmeli")) = 1 And If0Null(MasterTable2.Rows(0).Item("bVar")) = 1) Or If0Null(MasterTable.Rows(0).Item("Secmeli")) = 0 Then
                    ...
                    If NeoTable2.Rows.Count > 0 Then
                        ...
                        If Not drLakosCizgi Is Nothing Then
                            sbuf = "MANŞET(2cm) ÇİZzGİ:" & IfNull(drLakosCizgi("Aciklama"), "")
                        ...
                        If If0Null(NeoTable2.Rows(0).Item("bGarni1")) = 1 Then
                            ...
                            sbuf = "MANŞET(2cm) Garni1 RENK:" & AnaRenk1
                            nCizgi = 0
                        ...
                        If If0Null(NeoTable2.Rows(0).Item("bGarni2")) = 1 Then
                            ...
                            sbuf = "MANŞET(2cm) Garni2 RENK:" & AnaRenk2
                            nCizgi = 0
                    ...
                    End If
                    Aciklamalar.Add("MANŞET(2cm) Gramaj :" & IpGramaj & " " & sGramajArtis & "    T.Gramaj:" & TIpGramaj & " ")

                    Aciklamalar.Add("MANŞET(2cm) Adedi :" & ToplamAdet & " Tarak 3.5 cm Manşet")
                    '---------------------
                    ...
                    If NeoTable2.Rows(0).Item("bGarni1") = 1 Then
                        ...
                        Aciklamalar.Add("MANŞET(2cm) Garni 1 Gramaj :" & IpGramaj & " " & sGramajArtis & "    T.Gramaj:" & TIpGramaj)
                        Aciklamalar.Add("MANŞET(2cm) Garni 1 Adedi :" & ToplamAdet & " Tarak 3.5 cm Manşet")
                    ...
                    If NeoTable2.Rows(0).Item("bGarni2") = 1 Then
                        ...
                        Aciklamalar.Add("MANŞET(2cm) Garni 2 Gramaj :" & IpGramaj & " " & sGramajArtis & "    T.Gramaj:" & TIpGramaj)
                        Aciklamalar.Add("MANŞET(2cm) Garni 2 Adedi :" & ToplamAdet & " Tarak 3.5 cm Manşet")
                    ...
                    UretimBilgiYaz(SqlConn.SqlConnection, SipDetayID, "013", "MANŞET(2cm)", Aciklamalar, AnaRenkTam)
                    SiparisBilgiYaz(SqlConn.SqlConnection, SipDetayID, "013", "MANŞET(2cm)", Aciklamalar2, AnaRenkTam)
                End If
            End If
            '-----------------------------
        Catch ex As Exception
