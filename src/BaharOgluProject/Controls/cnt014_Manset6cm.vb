Public Class cnt014_Manset6cm
    Dim bNoAction As Boolean = False
    Dim YakaCizgiRKafa As String = ""

    Private Sub cnt014_Manset6cm_Initialize_Control(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control
        Try
    ...
    Private Sub cnt014_Manset6cm_Initialize_Control_ForAppMode(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control_ForAppMode
        Try
            ...
            Dim Manset6cmID As Long = 0

            If NeoTable2.Rows.Count > 0 Then
                Manset6cmID = NeoTable2.Rows(0).Item("nID")
            End If
            NeoTable3.Connection = Me.SqlConn
            NeoTable3.SelectCommand.CommandText &= " AND Manset6cmID>0 AND Manset6cmID=" & Manset6cmID & " "
            OpenTable(NeoTable3)

            tbGarni1Cizgiler.Connection = Me.SqlConn
            tbGarni1Cizgiler.SelectCommand.CommandText &= " AND Manset6cmID>0 AND Manset6cmID=" & Manset6cmID & " "
            OpenTable(tbGarni1Cizgiler)

            tbGarni2Cizgiler.Connection = Me.SqlConn
            tbGarni2Cizgiler.SelectCommand.CommandText &= " AND Manset6cmID>0 AND Manset6cmID=" & Manset6cmID & " "
    ...
    Private Sub cnt014_Manset6cm_IsOkay(ByVal sender As System.Windows.Forms.Control, ByRef e As IsOkayEventArgs) Handles Me.IsOkay
        Try
    ...
    Private Sub cnt014_Manset6cm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub cnt014_Manset6cm_Save_Control(ByVal sender As System.Windows.Forms.Control, ByRef e As Module1.SaveEventArgs) Handles Me.Save_Control
        Try
            ...
            Else
                ...
                If NeoTable2.Rows.Count > 0 Then
                    For Each dr As DataRow In NeoTable3.Rows
                        If dr.RowState <> DataRowState.Deleted And dr.RowState <> DataRowState.Detached Then
                            dr("Manset6cmID") = If0Null(NeoTable2.Rows(0).Item("nID"))
                        End If
                    Next
