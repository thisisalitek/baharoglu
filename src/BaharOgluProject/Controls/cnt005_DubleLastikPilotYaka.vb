Public Class cnt005_DubleLastikPilotYaka
    ...
    Private Sub cnt005_DubleLastikPilotYaka_Initialize_Control(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control
        Try
    ...
    Private Sub cnt005_DubleLastikPilotYaka_Initialize_Control_ForAppMode(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control_ForAppMode
        Try
    ...
    Private Sub cnt005_DubleLastikPilotYaka_IsOkay(ByVal sender As System.Windows.Forms.Control, ByRef e As IsOkayEventArgs) Handles Me.IsOkay
        Try
        ...
        End Try
    End Sub
    Private Sub cnt005_DubleLastikPilotYaka_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub cnt005_DubleLastikPilotYaka_Save_Control(ByVal sender As System.Windows.Forms.Control, ByRef e As Module1.SaveEventArgs) Handles Me.Save_Control
        Try
            ...
            If ApplicationMode = True Then
                If (If0Null(MasterTable.Rows(0).Item("Secmeli")) = 1 And If0Null(MasterTable2.Rows(0).Item("bVar")) = 1) Or If0Null(MasterTable.Rows(0).Item("Secmeli")) = 0 Then
                    ...
                    If MasterTable2.Rows.Count > 0 Then
                        ...
                        sSipBuf = "DUBLE LASTIK PILOT YAKA RENK:" & GetRenkKodIsim(SqlConn.SqlConnection, If0Null(MasterTable2.Rows(0).Item("RenkID")))
                        ...
                        End If
                        Aciklamalar.Add("DUBLE LASTIK PILOT YAKA TUR :" & If0Null(MasterTable.Rows(0).Item("Tur")) & "    T.Tur:" & TTur)
                    ...
                    UretimBilgiYaz(SqlConn.SqlConnection, SipDetayID, "005", "DUBLE LASTIK PILOT YAKA", Aciklamalar, AnaRenk)
                    SiparisBilgiYaz(SqlConn.SqlConnection, SipDetayID, "005", "DUBLE LASTIK PILOT YAKA", Aciklamalar2, AnaRenk)
                End If
            End If
            '-----------------------------
    ...
    Private Sub cmdRenkKafa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRenkKafa.Click
        Try
            ...
            With f
                ...
                .TipFilter = "DUBLE LASTIK PILOT YAKA"
...
Basa:
                    ...
                    For Each dr As DataRow In NeoTable2.Rows
                        ...
                        End If
                    Next
                    DubleLastikPilotYakaCizgiRKafa = IfNull(.ReturnDataRow("Aciklama"), "")
                End If
            End With
        Catch ex As Exception
            MsgBox(ex.Message)
