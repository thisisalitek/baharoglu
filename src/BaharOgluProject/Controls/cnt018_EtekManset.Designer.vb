...
Partial Class cnt018_EtekManset
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(cnt018_EtekManset))
        ...
        Me.NeoTable3_EtekMansetID = New System.Data.DataColumn()
        ...
        Me.lblCaption.Text = "Etek Manset (6cm)"
        '
        'XtraTabControl1
        '
        ...
        'SqlCommand4
        '
        Me.SqlCommand4.CommandText = "UPDATE KategoriParam_018_EtekManset SET Deleted = nID  , ModifiedBy = @ModifiedBy" &
    " , ModifiedDate = GETDATE()   WHERE nID = @nID"
        ...
        'SqlCommand1
        '
        Me.SqlCommand1.CommandText = "SELECT     *" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM         KategoriParam_018_EtekManset" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE Deleted = 0 " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        '
        'SqlCommand3
        '
        ...
        'NeoTable3
        '
        Me.NeoTable3.Columns.AddRange(New System.Data.DataColumn() {Me.NeoTable3_nID, Me.NeoTable3_Deleted, Me.NeoTable3_CreatedBy, Me.NeoTable3_CreatedDate, Me.NeoTable3_ModifiedBy, Me.NeoTable3_ModifiedDate, Me.NeoTable3_EtekMansetID, Me.NeoTable3_CizgiNo, Me.NeoTable3_RenkID})
        ...
        '
        'NeoTable3_EtekMansetID
        '
        Me.NeoTable3_EtekMansetID.ColumnName = "EtekMansetID"
        Me.NeoTable3_EtekMansetID.DataType = GetType(Integer)
        '
        'NeoTable3_CizgiNo
        '
        ...
        'SqlCommand28
        '
        Me.SqlCommand28.CommandText = "UPDATE SipDetayParam_018_EtekManset_Cizgiler SET Deleted = nID  , ModifiedBy = @M" &
    "odifiedBy , ModifiedDate = GETDATE()   WHERE nID = @nID"
        '
        'SqlCommand26
        '
        ...
        'SqlCommand25
        '
        Me.SqlCommand25.CommandText = "SELECT * FROM SipDetayParam_018_EtekManset_Cizgiler" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE Deleted = 0 " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        '
        'SqlCommand27
        '
    ...
    " , ModifiedDate = GETDATE()   WHERE nID = @nID"
        ...
        'SqlCommand17
        '
        Me.SqlCommand17.CommandText = "SELECT     *" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM         SipDetayParam_018_EtekManset" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE Deleted = 0 " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " "
        '
        'SqlCommand19
        '
    ...
    " = @ModifiedBy , ModifiedDate = GETDATE()   WHERE nID = @nID"
        ...
        Me.Caption = "Etek Manset (6cm)"
        Me.Code = "018"
        Me.Controls.Add(Me.TextEdit2)
        Me.Margin = New System.Windows.Forms.Padding(4)
        Me.Name = "cnt018_EtekManset"
