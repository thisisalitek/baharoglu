Public Class cnt019_Kaskorse
    ...
    Private Sub cnt019_Kaskorse_Initialize_Control(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control
        Try
    ...
    Private Sub cnt019_Kaskorse_Initialize_Control_ForAppMode(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control_ForAppMode
        Try
            ...
            Dim KarkoseID As Long = 0

            If NeoTable2.Rows.Count > 0 Then
                KarkoseID = NeoTable2.Rows(0).Item("nID")
            End If
    ...
    Private Sub cnt019_Kaskorse_IsOkay(ByVal sender As System.Windows.Forms.Control, ByRef e As IsOkayEventArgs) Handles Me.IsOkay
        Try
    ...
    Private Sub cnt019_Kaskorse_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub cnt019_Kaskorse_Save_Control(ByVal sender As System.Windows.Forms.Control, ByRef e As Module1.SaveEventArgs) Handles Me.Save_Control
        Try
    ...
    Private Sub NeoTable2_ColumnChanged(ByVal sender As Object, ByVal e As System.Data.DataColumnChangeEventArgs)
        Try
            If e Is Nothing Then Exit Sub
            If bNoAction = True Then Exit Sub
            bNoAction = True
    ...
    Private Sub LookUpEdit3_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub NeoTable3_ColumnChanged(ByVal sender As Object, ByVal e As System.Data.DataColumnChangeEventArgs)
        Try
            e.Row.EndEdit()
            MasraflariUygula()
        Catch ex As Exception
