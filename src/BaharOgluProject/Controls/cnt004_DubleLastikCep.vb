Public Class cnt004_DubleLastikCep
    Dim bNoAction As Boolean = False
    Dim DubleLastikCepCizgiRKafa As String = ""

    Private Sub cnt004_DubleLastikCep_Initialize_Control(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control
        Try
    ...
    Private Sub cnt004_DubleLastikCep_Initialize_Control_ForAppMode(ByVal sender As System.Windows.Forms.Control, ByVal e As System.EventArgs) Handles Me.Initialize_Control_ForAppMode
        Try
    ...
    Private Sub cnt004_DubleLastikCep_IsOkay(ByVal sender As System.Windows.Forms.Control, ByRef e As IsOkayEventArgs) Handles Me.IsOkay
        Try
    ...
    Private Sub cnt004_DubleLastikCep_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub cnt004_DubleLastikCep_Save_Control(ByVal sender As System.Windows.Forms.Control, ByRef e As Module1.SaveEventArgs) Handles Me.Save_Control
        Try
            ...
            If ApplicationMode = True Then
                ...
                If MasterTable2.Rows.Count > 0 Then
                    ...
                    If (If0Null(MasterTable.Rows(0).Item("Secmeli")) = 1 And If0Null(MasterTable2.Rows(0).Item("bVar")) = 1) Or If0Null(MasterTable.Rows(0).Item("Secmeli")) = 0 Then
                        ...
                        sSipBuf = "DUBLE LASTIK CEP RENK:" & GetRenkKodIsim(SqlConn.SqlConnection, If0Null(MasterTable2.Rows(0).Item("RenkID")))
                        ...
                        End If
                        Aciklamalar.Add("DUBLE LASTIK CEP TUR :" & If0Null(MasterTable.Rows(0).Item("Tur")) & "    T.Tur:" & TTur)
                        ...
                        'Aciklamalar.Add("------------------------------")
                        UretimBilgiYaz(SqlConn.SqlConnection, SipDetayID, "004", "DUBLE LASTIK CEP", Aciklamalar, AnaRenk)
                        SiparisBilgiYaz(SqlConn.SqlConnection, SipDetayID, "004", "DUBLE LASTIK CEP", Aciklamalar2, AnaRenk)
                    End If
