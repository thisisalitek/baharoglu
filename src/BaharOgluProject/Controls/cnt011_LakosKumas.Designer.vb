...
Partial Class cnt011_LakosKumas
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(cnt011_LakosKumas))
        ...
        Me.NeoTable1_OrguTip = New System.Data.DataColumn()
        ...
        'XtraTabControl1
        '
        Me.XtraTabControl1.Size = New System.Drawing.Size(487, 168)
        '
        'XtraTabPage1
        '
        ...
        'panelCaption
        '
        Me.panelCaption.Size = New System.Drawing.Size(487, 26)
        '
        'chkSecmeli
        '
        ...
        'NeoTable1_OrguTip
        '
        Me.NeoTable1_OrguTip.ColumnName = "OrguTip"
        Me.NeoTable1_OrguTip.DataType = GetType(Integer)
        '
        'NeoTable1_Iplik
        '
    ...
    " , ModifiedDate = GETDATE()   WHERE nID = @nID"
        ...
        'SqlCommand1
        '
        Me.SqlCommand1.CommandText = "SELECT * FROM KategoriParam_011_LakosKumas" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE Deleted = 0 "
        '
        'SqlCommand3
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colnID, Me.colKategoriParamID, Me.colKategoriID, Me.colParcaIsmi, Me.colIplik, Me.colIpGramaj, Me.colKumasGramaj, Me.colGramajArtis, Me.colOrguTip})
        ...
        Me.colKumasGramaj.VisibleIndex = 4
        Me.colKumasGramaj.Width = 64
        '
        'colGramajArtis
        '
        ...
        Me.colGramajArtis.VisibleIndex = 5
        Me.colGramajArtis.Width = 61
        '
        'colOrguTip
        '
    ...
    "ERE Deleted = 0 AND bLakos=1" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER BY OrguTipKod"
        ...
        'NeoTable2
        '
        Me.NeoTable2.Columns.AddRange(New System.Data.DataColumn() {Me.NeoTable2_nID, Me.NeoTable2_Deleted, Me.NeoTable2_CreatedBy, Me.NeoTable2_CreatedDate, Me.NeoTable2_ModifiedBy, Me.NeoTable2_ModifiedDate, Me.NeoTable2_SipDetayParamID, Me.NeoTable2_SourceID, Me.NeoTable2_KategoriParamID, Me.NeoTable2_ParcaIsmi, Me.NeoTable2_OrguTip, Me.NeoTable2_Iplik, Me.NeoTable2_IpGramaj, Me.NeoTable2_KumasGramaj, Me.NeoTable2_GramajArtis, Me.NeoTable2_RenkID})
    ...
    " , ModifiedDate = GETDATE()   WHERE nID = @nID"
        ...
        'SqlCommand9
        '
        Me.SqlCommand9.CommandText = "SELECT * FROM SipDetayParam_011_LakosKumas" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE Deleted = 0 "
        '
        'SqlCommand11
        '
    ...
    Friend WithEvents NeoTable1_OrguTip As System.Data.DataColumn
